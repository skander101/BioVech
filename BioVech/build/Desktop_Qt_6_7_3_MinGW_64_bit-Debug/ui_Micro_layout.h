...
"}"));
        ...
        gridLayout->addLayout(verticalLayout_2, 0, 1, 4, 1);
        ...
        gridLayout->addWidget(calendarWidget, 3, 0, 1, 1);
        ...
        connectarduino = new QPushButton(tab);
        connectarduino->setObjectName("connectarduino");
        connectarduino->setGeometry(QRect(0, 490, 121, 55));
        closearduino = new QPushButton(tab);
        closearduino->setObjectName("closearduino");
        closearduino->setGeometry(QRect(920, 490, 141, 55));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        closearduino->setText(QCoreApplication::translate("MainWindow", "close", nullptr));
